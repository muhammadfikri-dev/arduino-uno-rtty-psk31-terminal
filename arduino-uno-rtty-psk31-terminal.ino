/**
 * =========================================================================================
 * Project     : Arduino Uno RTTY & PSK31 Digital Amateur Radio Acoustic Modem
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Ham radio digital mode modem decoding 45.45 baud Baudot FSK RTTY and BPSK PSK31 signals directly from radio audio line-in using tone correlation filters.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno RTTY & PSK31 Digital Amateur Radio Acoustic Modem"));
